...
class ControllerSettingStore extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('setting/store', '', true));
		}
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('setting/store', '' . '&store_id=' . $this->request->get['store_id'], true));
		}
	...
	protected function getList() {
		...
		$data['add'] = $this->url->link('setting/store/add', '', true);
		$data['delete'] = $this->url->link('setting/store/delete', '', true);
		...
		$data['stores'][] = array(
			...
			'edit'     => $this->url->link('setting/setting', '', true)
		);
		...
		foreach ($results as $result) {
			$data['stores'][] = array(
				...
				'name'     => $result['name'],
				'url'      => $result['url'],
				'edit'     => $this->url->link('setting/store/edit', '' . '&store_id=' . $result['store_id'], true)
			);
		}
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['store_id'])) {
			$data['breadcrumbs'][] = array(
				...
				'href' => $this->url->link('setting/store/add', '', true)
			);
		} else {
			$data['breadcrumbs'][] = array(
				'text' => $this->language->get('text_settings'),
				'href' => $this->url->link('setting/store/edit', '' . '&store_id=' . $this->request->get['store_id'], true)
			);
		}
		...
		if (!isset($this->request->get['store_id'])) {
			$data['action'] = $this->url->link('setting/store/add', '', true);
		} else {
			$data['action'] = $this->url->link('setting/store/edit', '' . '&store_id=' . $this->request->get['store_id'], true);
		}

		$data['cancel'] = $this->url->link('setting/store', '', true);
