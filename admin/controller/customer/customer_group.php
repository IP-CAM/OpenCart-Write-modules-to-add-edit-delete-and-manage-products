...
class ControllerCustomerCustomerGroup extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('customer/customer_group', '' . $url, true));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('customer/customer_group', '' . $url, true)
		);

		$data['add'] = $this->url->link('customer/customer_group/add', '' . $url, true);
		$data['delete'] = $this->url->link('customer/customer_group/delete', '' . $url, true);
		...
		foreach ($results as $result) {
			$data['customer_groups'][] = array(
				...
				'edit'              => $this->url->link('customer/customer_group/edit', '' . '&customer_group_id=' . $result['customer_group_id'] . $url, true)
			);
		}
		...
		$data['sort_name'] = $this->url->link('customer/customer_group', '' . '&sort=cgd.name' . $url, true);
		$data['sort_sort_order'] = $this->url->link('customer/customer_group', '' . '&sort=cg.sort_order' . $url, true);
		...
		$pagination->url = $this->url->link('customer/customer_group', '' . $url . '&page={page}', true);
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['customer_group_id'])) {
			$data['action'] = $this->url->link('customer/customer_group/add', '' . $url, true);
		} else {
			$data['action'] = $this->url->link('customer/customer_group/edit', '' . '&customer_group_id=' . $this->request->get['customer_group_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('customer/customer_group', '' . $url, true);
