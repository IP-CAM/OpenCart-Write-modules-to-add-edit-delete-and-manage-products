	...
	public function customer_approval() {
		...
		foreach ($results as $result) {
			$data['customer_approvals'][] = array(
				...
				'approve'        => $this->url->link('customer/customer_approval/approve', '' . '&customer_id=' . $result['customer_id'] . '&type=' . $result['type'], true),
				'deny'           => $this->url->link('customer/customer_approval/deny', '' . '&customer_id=' . $result['customer_id'] . '&type=' . $result['type'], true),
				'edit'           => $this->url->link('customer/customer/edit', '' . '&customer_id=' . $result['customer_id'], true)
			);
		}
		...
		$pagination->url = $this->url->link('customer/customer_approval/customer_approval', '' . $url . '&page={page}', true);
