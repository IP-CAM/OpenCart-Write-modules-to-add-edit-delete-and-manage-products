...
class ControllerCustomerCustomer extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('customer/customer', '' . $url, true));
		}
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			...
			if ($login_info && $login_info['total'] >= $this->config->get('config_login_attempts')) {
				$unlock = $this->url->link('customer/customer/unlock', '' . '&email=' . $result['email'] . $url, true);
			} else {
				$unlock = '';
			}
			...
			$store_data[] = array(
				...
				'href' => $this->url->link('customer/customer/login', '' . '&customer_id=' . $result['customer_id'] . '&store_id=0', true)
			);

			foreach ($stores as $store) {
				$store_data[] = array(
					'name' => $store['name'],
					'href' => $this->url->link('customer/customer/login', '' . '&customer_id=' . $result['customer_id'] . '&store_id=' . $result['store_id'], true)
				);
			}
			...
			$data['customers'][] = array(
				...
				'unlock'         => $unlock,
				'store'          => $store_data,
				'edit'           => $this->url->link('customer/customer/edit', '' . '&customer_id=' . $result['customer_id'] . $url, true)
			);
		}
		...
		$data['sort_name'] = $this->url->link('customer/customer', '' . '&sort=name' . $url, true);
		$data['sort_email'] = $this->url->link('customer/customer', '' . '&sort=c.email' . $url, true);
		$data['sort_customer_group'] = $this->url->link('customer/customer', '' . '&sort=customer_group' . $url, true);
		$data['sort_status'] = $this->url->link('customer/customer', '' . '&sort=c.status' . $url, true);
		$data['sort_ip'] = $this->url->link('customer/customer', '' . '&sort=c.ip' . $url, true);
		$data['sort_date_added'] = $this->url->link('customer/customer', '' . '&sort=c.date_added' . $url, true);
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['customer_id'])) {
			...
			$data['action'] = $this->url->link('customer/customer/edit', '' . '&customer_id=' . $this->request->get['customer_id'] . $url, true);
		}
	...
	public function history() {
		...
		$pagination->page = $page;
		$pagination->limit = 10;
		$pagination->url = $this->url->link('customer/customer/history', '' . '&customer_id=' . $this->request->get['customer_id'] . '&page={page}', true);
	...
	public function transaction() {
		...
		$pagination->page = $page;
		$pagination->limit = 10;
		$pagination->url = $this->url->link('customer/customer/transaction', '' . '&customer_id=' . $this->request->get['customer_id'] . '&page={page}', true);
	...
	public function reward() {
		...
		$pagination->page = $page;
		$pagination->limit = 10;
		$pagination->url = $this->url->link('customer/customer/reward', '' . '&customer_id=' . $this->request->get['customer_id'] . '&page={page}', true);
	...
	public function ip() {
		...
		foreach ($results as $result) {
			$data['ips'][] = array(
				...
				'filter_ip'  => $this->url->link('customer/customer', '' . '&filter_ip=' . $result['ip'], true)
			);
		}
		...
		$pagination->page = $page;
		$pagination->limit = 10;
		$pagination->url = $this->url->link('customer/customer/ip', '' . '&customer_id=' . $this->request->get['customer_id'] . '&page={page}', true);
