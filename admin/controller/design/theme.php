	...
	public function history() {
		...
		foreach ($results as $result) {
			...
			$data['histories'][] = array(
				...
				'edit'       => $this->url->link('design/theme/template', '', true),
				'delete'     => $this->url->link('design/theme/delete', '' . '&theme_id=' . $result['theme_id'], true)
			);
		}
		...
		$pagination->limit = 10;
		$pagination->url = $this->url->link('design/theme/history', '' . '&page={page}', true);
