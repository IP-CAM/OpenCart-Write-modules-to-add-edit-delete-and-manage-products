...
class ControllerDesignSeoUrl extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('design/seo_url', '' . $url, true));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('design/seo_url', '' . $url, true)
		);

		$data['add'] = $this->url->link('design/seo_url/add', '' . $url, true);
		$data['delete'] = $this->url->link('design/seo_url/delete', '' . $url, true);
		...
		foreach ($results as $result) {
			$data['seo_urls'][] = array(
				...
				'edit'       => $this->url->link('design/seo_url/edit', '' . '&seo_url_id=' . $result['seo_url_id'] . $url, true)
			);
		}
		...
		$data['sort_query'] = $this->url->link('design/seo_url', '' . '&sort=query' . $url, true);
		$data['sort_keyword'] = $this->url->link('design/seo_url', '' . '&sort=keyword' . $url, true);
		$data['sort_store'] = $this->url->link('design/seo_url', '' . '&sort=store' . $url, true);
		$data['sort_language'] = $this->url->link('design/seo_url', '' . '&sort=language' . $url, true);
		...
		$pagination->url = $this->url->link('design/seo_url', '' . $url . '&page={page}', true);
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['seo_url_id'])) {
			$data['action'] = $this->url->link('design/seo_url/add', '' . $url, true);
		} else {
			$data['action'] = $this->url->link('design/seo_url/edit', '' . '&seo_url_id=' . $this->request->get['seo_url_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('design/seo_url', '' . $url, true);
