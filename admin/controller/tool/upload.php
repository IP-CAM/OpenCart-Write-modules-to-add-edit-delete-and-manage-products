...
class ControllerToolUpload extends Controller {
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			...
			$this->response->redirect($this->url->link('tool/upload', '' . $url, true));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('tool/upload', '' . $url, true)
		);

		$data['delete'] = $this->url->link('tool/upload/delete', '' . $url, true);
		...
		foreach ($results as $result) {
			$data['uploads'][] = array(
				...
				'download'   => $this->url->link('tool/upload/download', '' . '&code=' . $result['code'] . $url, true)
			);
		}
		...
		$data['sort_name'] = $this->url->link('tool/upload', '' . '&sort=name' . $url, true);
		$data['sort_filename'] = $this->url->link('tool/upload', '' . '&sort=filename' . $url, true);
		$data['sort_date_added'] = $this->url->link('tool/upload', '' . '&sort=date_added' . $url, true);
		...
		$pagination->url = $this->url->link('tool/upload', '' . $url . '&page={page}', true);
