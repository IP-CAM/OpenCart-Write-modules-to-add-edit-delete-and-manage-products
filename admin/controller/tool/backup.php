...
class ControllerToolBackup extends Controller {
	public function index() {
		...
		$data['export'] = $this->url->link('tool/backup/export', '', true);
	...
	public function import() {
		...
		if (!$json) {
			...
			if ($position && !feof($handle)) {
				$json['next'] = str_replace('&amp;', '&', $this->url->link('tool/backup/import', '' . '&import=' . $filename . '&position=' . $position, true));
	...
	public function export() {
		...
		if (!isset($this->request->post['backup'])) {
			...
			$this->response->redirect($this->url->link('tool/backup', '', true));
		} elseif (!$this->user->hasPermission('tool/backup')) {
