...
class ControllerCommonProfile extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('common/profile', '', true));
		}
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('common/profile', '', true)
		);

		$data['action'] = $this->url->link('common/profile', '', true);

		$data['cancel'] = $this->url->link('common/dashboard', '', true);
	...
	protected function validateForm() {
		if (!$this->user->hasPermission('common/profile')) {
