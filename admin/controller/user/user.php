...
class ControllerUserUser extends Controller {
	...
	protected function getList() {
		...
		$data['add'] = $this->url->link('user/user/add', '' . $url, true);
		$data['delete'] = $this->url->link('user/user/delete', '' . $url, true);
		...
		foreach ($results as $result) {
			$data['users'][] = array(
				...
				'edit'       => $this->url->link('user/user/edit', '' . '&user_id=' . $result['user_id'] . $url, true)
			);
		}
		...
		$data['sort_username'] = $this->url->link('user/user', '' . '&sort=username' . $url, true);
		$data['sort_status'] = $this->url->link('user/user', '' . '&sort=status' . $url, true);
		$data['sort_date_added'] = $this->url->link('user/user', '' . '&sort=date_added' . $url, true);
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['user_id'])) {
			$data['action'] = $this->url->link('user/user/add', '' . $url, true);
		} else {
			$data['action'] = $this->url->link('user/user/edit', '' . '&user_id=' . $this->request->get['user_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('user/user', '' . $url, true);
