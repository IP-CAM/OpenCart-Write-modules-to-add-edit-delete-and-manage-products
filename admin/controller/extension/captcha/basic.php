...
class ControllerExtensionCaptchaBasic extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/captcha/basic', '', true)
		);

		$data['action'] = $this->url->link('extension/captcha/basic', '', true);
	...
	protected function validate() {
		if (!$this->user->hasPermission('extension/captcha/basic')) {
