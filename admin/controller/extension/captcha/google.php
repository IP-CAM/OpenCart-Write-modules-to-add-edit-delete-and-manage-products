...
class ControllerExtensionCaptchaGoogle extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('marketplace/extension', '' . '&type=captcha', true));
		}
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('marketplace/extension', '' . '&type=captcha', true)
		);

		$data['breadcrumbs'][] = array(
			'text' => $this->language->get('heading_title'),
			'href' => $this->url->link('extension/captcha/google', '', true)
		);

		$data['action'] = $this->url->link('extension/captcha/google', '', true);

		$data['cancel'] = $this->url->link('marketplace/extension', '' . '&type=captcha', true);
	...
	protected function validate() {
		if (!$this->user->hasPermission('extension/captcha/google')) {
