...
class ControllerExtensionExtensionCaptcha extends Controller {
		...
		if ($files) {
			foreach ($files as $file) {
				...
				$data['extensions'][] = array(
					...
					'install'   => $this->url->link('extension/extension/captcha/install', '' . '&extension=' . $extension, true),
					'uninstall' => $this->url->link('extension/extension/captcha/uninstall', '' . '&extension=' . $extension, true),
					'installed' => in_array($extension, $extensions),
					'edit'      => $this->url->link('extension/captcha/' . $extension, '', true)
				);
			}
		}
	...
	protected function validate() {
		if (!$this->user->hasPermission('extension/extension/captcha')) {
