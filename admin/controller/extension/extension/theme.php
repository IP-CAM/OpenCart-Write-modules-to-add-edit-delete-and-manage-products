...
class ControllerExtensionExtensionTheme extends Controller {
		...
		if ($files) {
			foreach ($files as $file) {
				...
				$store_data[] = array(
					...
					'edit'   => $this->url->link('extension/theme/' . $extension, '' . '&store_id=0', true),
				...
				foreach ($stores as $store) {
					$store_data[] = array(
						'name'   => $store['name'],
						'edit'   => $this->url->link('extension/theme/' . $extension, '' . '&store_id=' . $store['store_id'], true),
				...
				$data['extensions'][] = array(
					...
					'install'   => $this->url->link('extension/extension/theme/install', '' . '&extension=' . $extension, true),
					'uninstall' => $this->url->link('extension/extension/theme/uninstall', '' . '&extension=' . $extension, true),
	...
	protected function validate() {
		if (!$this->user->hasPermission('extension/extension/theme')) {
