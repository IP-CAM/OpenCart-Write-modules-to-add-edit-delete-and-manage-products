...
class ControllerExtensionExtensionMenu extends Controller {
		...
		if ($files) {
			foreach ($files as $file) {
				...
				$data['extensions'][] = array(
					...
					'install'   => $this->url->link('extension/extension/menu/install', '' . '&extension=' . $extension, true),
					'uninstall' => $this->url->link('extension/extension/menu/uninstall', '' . '&extension=' . $extension, true),
					'installed' => in_array($extension, $extensions),
					'edit'      => $this->url->link('extension/menu/' . $extension, '', true)
				);
			}
		}
	...
	protected function validate() {
		if (!$this->user->hasPermission('extension/extension/menu')) {
