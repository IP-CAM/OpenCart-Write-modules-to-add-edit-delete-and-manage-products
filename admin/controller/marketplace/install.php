...
class ControllerMarketplaceInstall extends Controller {
	public function install() {
		...
		if (!$this->user->hasPermission('marketplace/install')) {
		...
		if (!$json) {
			...
			$json['next'] = str_replace('&amp;', '&', $this->url->link('marketplace/install/unzip', '' . '&extension_install_id=' . $extension_install_id, true));
		}
	...
	public function unzip() {
		...
		if (!$json) {
			...
			$json['next'] = str_replace('&amp;', '&', $this->url->link('marketplace/install/move', '' . '&extension_install_id=' . $extension_install_id, true));
		}
	...
	public function move() {
		...
		if (!$json) {
			...
			$json['next'] = str_replace('&amp;', '&', $this->url->link('marketplace/install/xml', '' . '&extension_install_id=' . $extension_install_id, true));
		}
	...
	public function xml() {
		...
		if (!$json) {
			...
			$json['next'] = str_replace('&amp;', '&', $this->url->link('marketplace/install/remove', '', true));
		}
