...
class ControllerMarketplaceEvent extends Controller {
	...
	public function enable() {
		...
		if (isset($this->request->get['event_id']) && $this->validate()) {
			...
			$this->response->redirect($this->url->link('marketplace/event', '' . $url, true));
		}
	...
	public function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('marketplace/event', '' . $url, true)
		);

		$data['delete'] = $this->url->link('marketplace/event/delete', '' . $url, true);
		...
		foreach ($results as $result) {
			$data['events'][] = array(
				...
				'enable'     => $this->url->link('marketplace/event/enable', '' . '&event_id=' . $result['event_id'] . $url, true),
				'disable'    => $this->url->link('marketplace/event/disable', '' . '&event_id=' . $result['event_id'] . $url, true),
		...
		$data['sort_code'] = $this->url->link('marketplace/event', '' . '&sort=code' . $url, true);
		$data['sort_sort_order'] = $this->url->link('marketplace/event', '' . '&sort=sort_order' . $url, true);
		$data['sort_status'] = $this->url->link('marketplace/event', '' . '&sort=status' . $url, true);
		...
		$pagination->url = $this->url->link('marketplace/event', '' . $url . '&page={page}', true);
