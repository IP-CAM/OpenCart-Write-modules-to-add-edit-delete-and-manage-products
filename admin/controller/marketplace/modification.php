...
class ControllerMarketplaceModification extends Controller {
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validate()) {
			...
			$this->response->redirect($this->url->link('marketplace/modification', '' . $url, true));
		}
	...
	public function refresh($data = array()) {
		...
		if ($this->validate()) {
			...
			$this->response->redirect($this->url->link(!empty($data['redirect']) ? $data['redirect'] : 'marketplace/modification', '' . $url, true));
		}
	...
	protected function getList() {
		...
		$data['refresh'] = $this->url->link('marketplace/modification/refresh', '' . $url, true);
		$data['clear'] = $this->url->link('marketplace/modification/clear', '' . $url, true);
		$data['delete'] = $this->url->link('marketplace/modification/delete', '' . $url, true);
		...
		foreach ($results as $result) {
			$data['modifications'][] = array(
				...
				'link'            => $result['link'],
				'enable'          => $this->url->link('marketplace/modification/enable', '' . '&modification_id=' . $result['modification_id'], true),
				'disable'         => $this->url->link('marketplace/modification/disable', '' . '&modification_id=' . $result['modification_id'], true),
		...
		$data['sort_status'] = $this->url->link('marketplace/modification', '' . '&sort=status' . $url, true);
		...
		$pagination->url = $this->url->link('marketplace/modification', '' . $url . '&page={page}', true);
		...
		$data['clear_log'] = $this->url->link('marketplace/modification/clearlog', '', true);
