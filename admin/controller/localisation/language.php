...
class ControllerLocalisationLanguage extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('localisation/language', '' . $url, true));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('localisation/language', '' . $url, true)
		);

		$data['add'] = $this->url->link('localisation/language/add', '' . $url, true);
		$data['delete'] = $this->url->link('localisation/language/delete', '' . $url, true);
		...
		foreach ($results as $result) {
			$data['languages'][] = array(
				...
				'edit'        => $this->url->link('localisation/language/edit', '' . '&language_id=' . $result['language_id'] . $url, true)
			);
		}
		...
		$data['sort_name'] = $this->url->link('localisation/language', '' . '&sort=name' . $url, true);
		$data['sort_code'] = $this->url->link('localisation/language', '' . '&sort=code' . $url, true);
		$data['sort_sort_order'] = $this->url->link('localisation/language', '' . '&sort=sort_order' . $url, true);
		...
		$pagination->url = $this->url->link('localisation/language', '' . $url . '&page={page}', true);
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['language_id'])) {
			$data['action'] = $this->url->link('localisation/language/add', '' . $url, true);
		} else {
			$data['action'] = $this->url->link('localisation/language/edit', '' . '&language_id=' . $this->request->get['language_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('localisation/language', '' . $url, true);
