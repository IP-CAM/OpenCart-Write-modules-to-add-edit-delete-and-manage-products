...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 02, 2019 lúc 08:27 PM
...
--
-- Cấu trúc bảng cho bảng `oc_sanpham`
--

CREATE TABLE `oc_sanpham` (
  `id` int(11) NOT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `oc_sanpham`
--

INSERT INTO `oc_sanpham` (`id`, `ten_sp`, `mota_sp`, `time`) VALUES
(1, 'Nguyên', 'Đây là ô nhập sản phẩm 1', '1556841157'),
(2, 'Nguyên 2', 'Đây là ô nhập sản phẩm 2', '1556841157'),
(11, 'fefeeeeeeeeeeeeeeeeeeee2e2e2e2', 'đwdwwwwwwwwwwwwwwwwwwwwwwwww', '1556846415'),
(12, 'rfewfefe', 'fefefefeffewfefefefefefefefefe', '1556845660');
...
('34fa4161dc647f663d58106042', '{\"language\":\"en-gb\"}', '2019-05-02 14:17:56'),
('889d92e53ee3e241339d67cacb', '{\"language\":\"en-gb\"}', '2019-05-02 14:29:56'),
('d4fbde5290da7287d8b6398f9f', '{\"language\":\"en-gb\",\"user_id\":\"1\"}', '2019-05-02 18:45:45');
...
(1, 1, 'admin', '69913bbe4c9eb9117fa15572a75705979a3c2eba', 'F3qIGUKVD', 'John', 'Doe', 'admin@mail.com', '', '', '::1', 1, '2018-11-06 16:01:47'),
(2, 1, 'nguyen', '0f0b471a25a36c464e74a9d5bca95fd82c913505', 'o6L3azKpH', 'nguyen', 'nguyen', 'uawfwqvcawgwg@gmail.com', '', '', '', 1, '2019-05-03 00:03:54');
...
--
-- Chỉ mục cho bảng `oc_sanpham`
--
ALTER TABLE `oc_sanpham`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT cho bảng `oc_sanpham`
--
ALTER TABLE `oc_sanpham`
